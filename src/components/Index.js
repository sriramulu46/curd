...
class Index extends Component
{
	constructor() {
		...
		this.state = {
			users     : [
				// {id : 1, Emp Name : "Moazzam Hossain",  : "88018 29887799", email : "moazzam@gmail.com"},
				// {id : 2, EmpName : "Azim Uddin", mobile_no : "88017 23665544", email : "azim@gmail.com"},
				// {id : 3, EmpName : "Sojol Kaisar", mobile_no : "88016 26332211", email : "sojol@gmail.com"}
			],
			editUser : {}
		}
                        ...
                        <table className="table table-bordered">
                            ...
                            {this.state.users.map((user, i) => (
                                <tr key={i}>
                                    <td> {user.id} </td>
                                    <td> {user.EmpName} </td>
                                    <td> {user.Role_Maturity} </td>
                                    <td> {user.Skill_Profile} </td>
                                    <td>
